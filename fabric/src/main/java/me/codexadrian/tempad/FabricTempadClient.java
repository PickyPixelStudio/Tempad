...
public class FabricTempadClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        TempadClient.init();
        EntityRendererRegistry.INSTANCE.register(FabricTempad.TIMEDOOR_ENTITY_ENTITY_TYPE, (entityRendererDispatch, ctx) -> new TimedoorRenderer(entityRendererDispatch));
